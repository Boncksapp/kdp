  ...
  try {
    ...
    switch (action) {
      ...
      case "generate-metadata":
        endpoint = `${BACKEND_URL}/api/v1/projects/${body.project_id}/metadata/generate`;
        payload = {
          profile_name: body.profile_name || "default",
        ...
        break;
      case "billing-usage":
        endpoint = `${BACKEND_URL}/api/v1/billing/usage?profile_name=${body.profile_name || "default"}`;
        method = "GET";
        payload = undefined;
        break;
      case "billing-tiers":
        endpoint = `${BACKEND_URL}/api/v1/billing/tiers?profile_name=${body.profile_name || "default"}`;
        method = "GET";
        payload = undefined;
        break;
